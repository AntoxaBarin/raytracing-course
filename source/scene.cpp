...
std::ostream& operator<<(std::ostream& out, const Scene& scene) {
    out << "H: " << scene.height << " W: " << scene.width << '\n'
          ...
          << "POSITION: " << scene.camera.camera_position.x << ' ' << scene.camera.camera_position.y << ' '
          << scene.camera.camera_position.z << '\n'
          ...
          << "FORWARD: " << scene.camera.camera_forward.x << ' ' << scene.camera.camera_forward.y << ' '
          << scene.camera.camera_forward.z << "\n\n";
